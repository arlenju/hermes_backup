...
description: >
  ...
  特别参考：references/mcporter-call-syntax.md（mcporter call 正确语法 + Twitter
  渠道未配 Cookie 时的 trends24 + Exa 替代路线）。
...
| **X/Twitter 热搜（无 Cookie）** | **social** | **[references/trends-without-auth.md](references/trends-without-auth.md)** |
| 招聘/职位/LinkedIn | career | [references/career.md](references/career.md) |
| GitHub/代码 | dev | [references/dev.md](references/dev.md) <br/> 🔁 当 web_extract 屏蔽时： [references/github-api-research.md](references/github-api-research.md) |

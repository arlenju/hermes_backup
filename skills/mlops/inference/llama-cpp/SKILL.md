...
- **[lm-studio-install.md](references/lm-studio-install.md)** — Download GGUF models from Hugging Face and install into LM Studio. Covers `hf` CLI, aria2, curl, mirror sites for China, and LM Studio model directory layout.

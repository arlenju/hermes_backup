...
§
Fallback: deepseek-v4-flash → openrouter/gemma-4-31b-it:free (无 lmstudio). ARK ark-2281c7...17 = Agent Plan 订阅, 仅含 DeepSeek V4 文本, 不含 vision (Plan 端 404, /api/v3 端 401).
§
